...
\[
g_0:=f_0,\qquad 
g_{n+1}:=f_{n+1}-\sum_{k=0}^n\frac{\langle f_{n+1},f_k\rangle}{\langle g_k,g_k\rangle}\,g_k.
\]
...
\begin{flalign*}
    g_1 = f_1 - \frac{\langle f_1, f_0\rangle}{\langle g_0, g_0\rangle}g_0 = f_1 -\frac{\langle f_1, f_0\rangle}{\langle f_0, f_0\rangle}f_0
\end{flalign*}
...
\begin{flalign*}
  g_{n+1} &= f_{n+1} - \sum_{k=0}^{n}\frac{\langle f_{n+1}, g_k\rangle}{\langle g_k, g_k\rangle} \Rightarrow \langle g_{n+1}, g_j\rangle = \langle f_{n+1}, g_j\rangle - \sum_{k=0}^{n}\frac{\langle f_{n+1},g_k\rangle}{\langle g_k,g_k\rangle}\cdot \langle g_k, g_j\rangle =&&\\
