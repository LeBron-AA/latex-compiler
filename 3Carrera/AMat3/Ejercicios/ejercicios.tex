...
\vspace{4mm}
\textbf{6)} Demuestra que existe un conjunto abierto $O$ en $\R$ y un $\varepsilon > 0$ tal que para cualquier recubrimiento finito de $O$ formado por intervalos abiertos, $\{J_i\}_{i=1}^m$ se cumple $\mu(\smallcup_{i=1}^n J_i \setminus O) > \varepsilon$.
\vspace{2mm}
...
$$(n+1 - \frac{1}{3}) - (n + \frac{1}{3}) = 1 - \frac{2}{3} = \frac{1}{3}$$
