...
\item los siguientes enunciados son equivalentes:
  ...
  \item dadas \(f\) y \(g\) en \(\mathcal L_2(I)\), \(\langle f,\varphi_n\rangle=\langle g,\varphi_n\rangle\) para todo \(n\) implica \(f\equiv g\) a.e.
  \item dada \(f\in\mathcal L_2(I)\), \(\langle f,\varphi_n\rangle=0\) para todo \(n\) implica \(f\equiv 0\).
