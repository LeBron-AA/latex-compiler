...
\vspace{2mm}
\dem \newline \indent Sea $A_n = A \cap [-n,n]^N$, tenemos que $(A_n)_n$ es una sucesión creciente de conjuntos medible que tiene como unión el conjunto $A$. Por tanto, se tiene
