...
\begin{enumerate}[label=\roman*)]
    \item $o \leq f \leq g \Rightarrow \int_{X}f\,d\mu \leq \int_{X}g\,d\mu$
...
\newline \vspace{2mm} \indent Este razonamiento de extender $t$ a $\hat{t}$ demuestra también que $\mathcal{S}_E(f) \subseteq \mathcal{S}_F(f)$ luego por definición de supremo se tiene:
