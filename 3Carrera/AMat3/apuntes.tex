...
Por todo lo anterior, $$E = \underbracket{\hspace{1mm} D \hspace{1mm} }_{\in \mathfrak{B}_N} \cup \underbracket{\hspace{1mm} M \hspace{1mm}}_{\in \widetilde{\mathfrak{B}_N}} \in \widetilde{\mathfrak{B}}_N$$
...
$$\int_{X}f\,d\mu = \sup\left\{\lbint_{X}s\,d\mu \hspace{2mm} \text{ con } 0 \leq s \leq f, \hspace{1mm} s \text{ función simple medible}\right\} = \sup \mathcal{S}_X(f)$$
...
\begin{adjustwidth}{0.07\textwidth}{}
    ...
    \begin{flalign*}
        \int_{X}&|f - f_{k_n}|^p\,d\mu = \int_{X \setminus A}|f - f_{k_n}|^p\,d\mu \overset{\hyperref[result:2.1.13]{Fatou}}{\leq} \linf{m} \int_{X \setminus A}|f_{k_m}(x) - f_{k_n}(x)|\,d\mu(x) = \\[1.5ex]
...
\begin{adjustwidth}{0.07\textwidth}{}
    ...
    $$A_{n,m} := \Big\{x \in X : ||f_n(x) - f(x)||_\infty \leq ||f_n - f_m||_\infty \Big\} $$
    ...
    $$ \forall \hspace{1mm} x \in X \setminus B, \hspace{2mm} \forall \hspace{1mm} n,m \geq n_\varepsilon : |f_n(x) - f_m(x)| \leq ||f_n - f_m|| < \varepsilon$$
