...
\begin{adjustwidth}{0.07\textwidth}{}
    ...
    \begin{flalign*}
        \int_{X}&|f(x)+p(x)|\,d\mu(x) = \int_{X} \Big|\hspace{1mm} \underbrace{\frac{1}{2}}_\lambda\cdot \hspace{1mm} 2f(x)+ \underbrace{\frac{1}{2}}_{1-\lambda}\cdot \hspace{1mm} 2g(x)\hspace{1mm} \Big|^p\,d\mu(x) = (*)
    \end{flalign*}
