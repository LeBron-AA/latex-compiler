...
$$(*)= f(t_n, \xi_n) \cdot \frac{b(t_n)-b(t_0)}{t_n - t_0} - f(t_n, \zeta_n)\cdot \frac{a(t_n) - a(t_0)}{t_n - t_0} + \int_{a(t_0)}^{b(t_0)}\frac{f(t_n, x) - f(t_0, x)}{t_n - t_0}$$
...
\vspace{2mm} Por el Teorema del Valor Medio de Derivación, existe $\theta_n \in I_{t_n, t_0}$ tal que 
\end{document}