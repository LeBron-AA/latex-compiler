...
\vspace{2mm}
Sea $n \in \N$ cualquiera, $\sigma_n^g = \frac{1}{n}\Big(s_1^g + \ldots + s_n^g\Big)$. Por haber escogido $g$ y no $f$, tenemos que todas las $s_k^g$ tienen su término independiente nulo.  %TODO acabar
