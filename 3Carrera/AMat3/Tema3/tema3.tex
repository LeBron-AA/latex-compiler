...
\hspace{3mm} Un $K$-espacio vectorial $V$ se dice ``seminormado'' si existe una aplicación $||\cdot|| : V \longrightarrow\R$ (llamada ``seminorma de $V$'') que cumple las siguientes condiciones:
