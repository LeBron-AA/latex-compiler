...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{media/algoritmos/multihilo/task.png}
\end{figure}
\newpage
...
Estos valores muestran que, para nuestro algoritmo de inversión en blanco y negro, la paralelización mediante hilos ofrece una mejora significativa del rendimiento, mientras que la versión SIMD no logra superar al enfoque monohilo debido al pequeño volumen de píxeles por operación al ser solo 2 el ancho del paquete.
