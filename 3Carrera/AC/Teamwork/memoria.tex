...
Los tres programas realizan la misma tarea (tienen la misma carga de trabajo), solamente cambia cómo la llevan a cambio. Por tanto, podemos calcular la aceleración a partir de los tiempos medios obtenidos para cada implementación. Calculamos la aceleración relativa frente a la versión monohilo, definida como:
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/antes/monohilo.png}
    \caption*{Imagen original}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/despues/monohilo.png}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/antes/simd.png}
    \caption*{Imagen original}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/despues/simd.png}
    \caption*{Resultado tras aplicar el algoritmo}
\end{minipage}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/antes/multihilo.png}
    \caption*{Imagen original}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{media/despues/multihilo.png}
    \caption*{Resultado tras aplicar el algoritmo}
\end{minipage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{media/comparaciones/diffImages_Monohilo_SIMD.png}
    \caption*{Ejecución de \texttt{diffImages} comparando SIMD con Monohilo}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{media/comparaciones/diffImages_Monohilo_SIMD_consola.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{media/comparaciones/diffImages_Monohilo_Multihilo.png}
    \caption*{Ejecución de \texttt{diffImages} comparando Monohilo con Multihilo}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{media/comparaciones/diffImages_Monohilo_Multihilo_consola.png}
    \caption*{Salida por consola}
\end{figure}
\end{document}